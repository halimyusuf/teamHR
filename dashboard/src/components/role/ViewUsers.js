            ...
            mydata.map((o, i) => {
                ...
                return (
                    <tr key={o.id}>
                        ...
                        <td><button class="btn btn-danger btn-xs" style={{ borderRadius: "50px", width: "10px" }} onClick={this.handleDelete} id={o.id}><i className="material-icons" id={o.id} style={{ left: "-6px", fontSize: "13px" }}>delete_sweep</i></button></td>
                    </tr>
                )
            })
        ) : (
